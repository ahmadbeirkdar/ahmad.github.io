...
* ### CPS109 - Computer Science 1
    ...
    * Resources for the Course:
        * Python Docs - [click here](https://docs.python.org/3/)
    * Reach Ahead & Enrich your Learning & Projects:
        * Really cool Udemy course - [click here](https://www.udemy.com/course/complete-python-bootcamp/)
        * Possible Projects:
            * Discord bot - [click here](https://realpython.com/how-to-make-a-discord-bot-python/)
...
* ### CPS213 - Computer Organization I
    ...
    * Reach Ahead & Enrich your Learning & Projects:
        * Ben Eater videos: [Ben Eater](https://www.youtube.com/channel/UCS0N5baNlQWJCUrhCEo8WlA)
        * Do your own 8-bit computer! [Building a 8-bit Computer](https://www.youtube.com/watch?v=HyznrdDSSGM&list=PLowKtXNTBypGqImE405J2565dvjafglHU)
    * Review:
...
* ### CPS305 - Data Structures
    ...
    * Resources for the Course:
        * Geekforgeeks! Data structure implementations and explanations - [click here](https://www.geeksforgeeks.org/data-structures/?ref=shm)
        * Need more lectures to suplement the lectures? Check out Abdul Bari's channel - [click here](https://www.youtube.com/channel/UCZCFT11CWBi3MHNlGf019nw)
    * Reach Ahead & Enrich your Learning & Projects:
        * Start practicing some leetcode! Helpful for interviews for Co-op - [LeetCode](https://leetcode.com/)
    * Review:
...
* ### CPS393 - 	Introduction to UNIX & C 
    ...
    * Resources for the Course:
        * The C Programming Language book - [Amazon](https://www.amazon.ca/Programming-Language-2nd-Brian-Kernighan/dp/0131103628)
        * The Linux man pages for every command/program 
    * Reach Ahead & Enrich your Learning & Projects:
        * Interested in systems programming now? Checkout Rust!    
            * What's Rust - [Rust](https://www.rust-lang.org/)
            * Book - [Rust Book](https://doc.rust-lang.org/book/)
        * Do you like UNIX? Starting booting Linux on your computer, checkout - [Install Manjaro](https://manjaro.org/support/firststeps/)
    * Review:
...
* ### CPS506 - 	Comparative Programming Languages
    ...
    * Resources for the Course:
        ...
        * Rust Book - [Rust Book](https://doc.rust-lang.org/book/)
        * Haskell Book - [Haskell Book](https://haskellbook.com/)
    * Reach Ahead & Enrich your Learning & Projects:
        * Rust Book - [Rust Book](https://doc.rust-lang.org/book/)
...
* ### CPS590 - 	Operating Systems I
    * Description:
        * Introduction to OS
    * Resources for the Course:
        * Book, Operating Systems: Three Easy Pieces - [Book](https://pages.cs.wisc.edu/~remzi/OSTEP/)
    * Reach Ahead & Enrich your Learning & Projects:
